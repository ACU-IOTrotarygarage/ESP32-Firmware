...
//           V2.00 2020-06-11 - Integration into Firmware
//           V2.01 2020-08-11 - Merged LibTeleinfo official and Firmware version
        ...
        if(strlen(ptok) && strlen(pvalue)) {
          ...
          if ( calc_checksum == checksum) {
            ...
            if ( me ) {
              ...
              // Firmware need to to calulation on Energy Module
