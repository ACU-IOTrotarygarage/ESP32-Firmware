...
// int MLX90640_TriggerMeasurement(uint8_t slaveAddr) // ATM not used in Firmware
// {
//     int error = 1;
//     uint16_t ctrlReg;
...
int MLX90640_ExtractParameters(uint16_t *eeData, paramsMLX90640 *mlx90640, int _chunk) // Firmware
{
    int error = 0;
    switch(_chunk){
      case 0:
