...
*/
  ...
  // data from older versions of Firmware.
  ...
  // calcualted for compatibility with older versions of Firmware. Normally,
...
#include "t_bearssl_Firmware_config.h"
