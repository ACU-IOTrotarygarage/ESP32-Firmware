/*
  FirmwareModbus.h - Basic modbus wrapper for FirmwareSerial for Firmware
...
#ifndef FirmwareModbus_h
#define FirmwareModbus_h
...
class FirmwareModbus : public FirmwareSerial {
  public:
    FirmwareModbus(int receive_pin, int transmit_pin, int tx_enable_pin = -1);
    virtual ~FirmwareModbus() {}
