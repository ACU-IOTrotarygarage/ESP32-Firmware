...
Firmware.Rule_Matcher.parse("AA#BB#CC")
# [<Matcher key='AA'>, <Matcher key='BB'>, <Matcher key='CC'>]

Firmware.Rule_Matcher.parse("AA")
# [<Matcher key='AA'>]

Firmware.Rule_Matcher.parse("AA#BB#CC=2")
# [<Matcher key='AA'>, <Matcher key='BB'>, <Matcher key='CC'>, <Matcher op '=' val='2'>]

Firmware.Rule_Matcher.parse("AA#BB#CC>=3.5")
...
class Rule_Matcher
  ...
  def op_parse(op, op_value)
    ...
    def op_eq_str(a,b)     return Firmware._apply_str_op(1, str(a), b) end
    def op_neq_str(a,b)    return Firmware._apply_str_op(2, str(a), b) end
    def op_start_str(a,b)  return Firmware._apply_str_op(3, str(a), b) end
    def op_end_str(a,b)    return Firmware._apply_str_op(4, str(a), b) end
    def op_sub_str(a,b)    return Firmware._apply_str_op(5, str(a), b) end
    def op_notsub_str(a,b) return Firmware._apply_str_op(6, str(a), b) end
  ...
  static def parse(pattern)
    ...
    var op_list = Firmware.find_op(pattern)
