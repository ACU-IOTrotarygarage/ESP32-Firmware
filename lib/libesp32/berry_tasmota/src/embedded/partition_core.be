...
class Partition_info
  ...
  def get_image_size()
    ...
    try
      ...
      Firmware.log("BRY: Exception> '" + e + "' - " + m, 2)
      return -1
    end
  end
...
class Partition
  ...
  def resize_fs_to_max()
    ...
    try
      ...
      Firmware.log(string.format("BRY: Trying to expand FS by %i kB", unallocated), 2)
      ...
      # restart
      Firmware.global.restart_flag = 2
      Firmware.log("BRY: Successfully resized FS, restarting", 2)
    except .. as e, m
