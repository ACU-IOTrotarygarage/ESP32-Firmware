...
class Leds : Leds_ntv
  ...
  def to_gamma(rgbw, bri)
    bri = (bri != nil) ? bri : 100
    var r = Firmware.scale_uint(bri, 0, 100, 0, (rgbw & 0xFF0000) >> 16)
    var g = Firmware.scale_uint(bri, 0, 100, 0, (rgbw & 0x00FF00) >> 8)
    var b = Firmware.scale_uint(bri, 0, 100, 0, (rgbw & 0x0000FF))
    if self.gamma
