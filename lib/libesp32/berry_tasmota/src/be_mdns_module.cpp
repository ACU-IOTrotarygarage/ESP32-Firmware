...
// start or restart mdns, specify hostname or use Firmware.hostname() if none provided (default)
...
//
// Test:
//    import mdns mdns.add_service("_arduino","_tcp",1111, {"board":"Firmware", "tcp_check":"no", "ssh_upload":"no", "auth_upload":"no"})
//
...
//
extern "C" esp_err_t __Firmware_mdns_service_subtype_add_for_host (const char *instance_name, const char *service_type, const char *proto, const char *hostname, const char *subtype)
{ return ESP_OK; }
extern "C" esp_err_t mdns_service_subtype_add_for_host(const char *instance_name, const char *service_type, const char *proto, const char *hostname, const char *subtype) __attribute__ ((weak, alias ("__Firmware_mdns_service_subtype_add_for_host")));
