/* Solidification of lv_Firmware.h */
/********************************************************************\
...
********************************************************************/
be_local_closure(lv_Firmware_init,   /* name */
  be_nested_proto(
    5,                          /* nstack */
    1,                          /* argc */
    0,                          /* varg */
    ...
    /* K30  */  be_nested_str_weak(Firmware),
...
be_local_closure(splash_runner_init,   /* name */
  be_nested_proto(
    ...
    /* K0   */  be_nested_str_weak(Firmware),
...
be_local_closure(splash_runner_display,   /* name */
  be_nested_proto(
    ...
    /* K3   */  be_nested_str_weak(Firmware),
...
********************************************************************/
be_local_closure(lv_Firmware_splash_init,   /* name */
  be_nested_proto(
    3,                          /* nstack */
    0,                          /* argc */
    0,                          /* varg */
...
********************************************************************/
be_local_closure(lv_Firmware_splash_remove,   /* name */
  be_nested_proto(
    3,                          /* nstack */
    0,                          /* argc */
    0,                          /* varg */
...
********************************************************************/
be_local_closure(lv_Firmware_splash,   /* name */
  be_nested_proto(
    14,                          /* nstack */
    0,                          /* argc */
    0,                          /* varg */
    ...
    /* K21  */  be_nested_str_weak(set_Firmware_logo),
    ...
    /* K31  */  be_nested_str_weak(Firmware),
    ...
    /* K39  */  be_nested_str_weak(Firmware),
