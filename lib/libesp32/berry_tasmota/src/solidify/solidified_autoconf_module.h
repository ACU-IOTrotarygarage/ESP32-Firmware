...
be_local_closure(Autoconf_page_autoconf_ctl,   /* name */
  be_nested_proto(
    ...
    /* K19  */  be_nested_str(https_X3A_X2F_X2Fraw_X2Egithubusercontent_X2Ecom_X2FFirmware_X2Fautoconf_X2Fmain_X2F_X25s_X2F_X25s_X2Eautoconf),
...
be_local_closure(Autoconf_load_templates,   /* name */
  be_nested_proto(
    ...
    /* K3   */  be_nested_str(https_X3A_X2F_X2Fraw_X2Egithubusercontent_X2Ecom_X2FFirmware_X2Fautoconf_X2Fmain_X2F_X25s_manifest_X2Ejson),
    /* K4   */  be_nested_str(Firmware),
