...
be_local_closure(Matter_Plugin_Temp_Sensor_parse_sensors,   /* name */
  be_nested_proto(
    ...
    /* K0   */  be_nested_str_weak(Firmware_sensor_matcher),
...
be_local_closure(Matter_Plugin_Temp_Sensor_init,   /* name */
  be_nested_proto(
    ...
    /* K1   */  be_nested_str_weak(Firmware_sensor_filter),
    /* K2   */  be_nested_str_weak(Firmware_sensor_matcher),
...
be_local_class(Matter_Plugin_Temp_Sensor,
    ...
    ( (struct bvalue*) &(const bvalue[]) {
        ...
        { be_const_key_weak(Firmware_sensor_filter, 8), be_const_var(0) },
        { be_const_key_weak(Firmware_sensor_matcher, -1), be_const_var(1) },
