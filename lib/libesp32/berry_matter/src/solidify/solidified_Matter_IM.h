...
be_local_closure(Matter_IM_process_invoke_request,   /* name */
  be_nested_proto(
    ...
    /* K24  */  be_nested_str_weak(Firmware),
...
be_local_closure(Matter_IM_subscribe_request,   /* name */
  be_nested_proto(
    ...
    /* K16  */  be_nested_str_weak(Firmware),
  ...
  be_nested_proto(
    ...
    ( &(const struct bproto*[ 2]) {
      be_nested_proto(
        ...
        /* K20  */  be_nested_str_weak(Firmware),
  ...
  be_nested_proto(
    ...
    ( &(const struct bproto*[ 2]) {
      be_nested_proto(
        ...
        /* K26  */  be_nested_str_weak(Firmware),
    ...
    /* K14  */  be_nested_str_weak(Firmware),
...
be_local_closure(Matter_IM_send_subscribe_update,   /* name */
  be_nested_proto(
    ...
    /* K13  */  be_nested_str_weak(Firmware),
...
be_local_closure(Matter_IM_send_enqueued,   /* name */
  be_nested_proto(
    ...
    /* K5   */  be_nested_str_weak(Firmware),
