...
class Matter_Frame
  ...
  def build_response(opcode, reliable, resp)
    ...
    if resp.local_session_id == 0
      ...
      Firmware.log(string.format("MTR: <Replied   (%6i) %s", resp.session.local_session_id, op_name), 2)
    end
    return resp
  end
 ...
 #
  ...
  def decrypt()
    ...
    if self.sec_p
      ...
      Firmware.log("MTR: >>>>>>>>>>>>>>>>>>>> Compute Privacy TODO", 2)
    ...
    # Firmware.log("MTR: ******************************", 4)
    # Firmware.log("MTR: i2r         =" + i2r.tohex(), 4)
    # Firmware.log("MTR: p           =" + p.tohex(), 4)
    # Firmware.log("MTR: a           =" + a.tohex(), 4)
    # Firmware.log("MTR: n           =" + n.tohex(), 4)
    # Firmware.log("MTR: mic         =" + mic.tohex(), 4)
    ...
    # Firmware.log("MTR: ******************************", 4)
    # Firmware.log("MTR: cleartext   =" + cleartext.tohex(), 4)
    # Firmware.log("MTR: tag         =" + tag.tohex(), 4)
    # Firmware.log("MTR: ******************************", 4)

    if tag != mic
      Firmware.log("MTR: rejected packet due to invalid MIC", 2)
      return nil
    end
  ...
  def encrypt()
    ...
    # Firmware.log("MTR: cleartext: " + self.raw.tohex(), 4)

    # Firmware.log("MTR: ******************************", 4)
    # Firmware.log("MTR: r2i         =" + r2i.tohex(), 4)
    # Firmware.log("MTR: p           =" + p.tohex(), 4)
    # Firmware.log("MTR: a           =" + a.tohex(), 4)
    # Firmware.log("MTR: n           =" + n.tohex(), 4)
    ...
    # Firmware.log("MTR: ******************************", 4)
    # Firmware.log("MTR: ciphertext  =" + ciphertext.tohex(), 4)
    # Firmware.log("MTR: tag         =" + tag.tohex(), 4)
    # Firmware.log("MTR: ******************************", 4)
    ...
    # Firmware.log("MTR: encrypted: " + self.raw.tohex(), 4)
  end
  ...
  def debug(raw)
    ...
    r.decode_header()
    r.decode_payload()
    Firmware.log("MTR: sending decode: " + matter.inspect(r), 4)
  end
end
