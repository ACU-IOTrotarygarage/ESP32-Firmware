...
class Matter_Fabric : Matter_Expirable
  ...
  def counter_group_data_snd_next()
    ...
    Firmware.log(string.format("MTR: .          Counter_group_data_snd=%i", next), 3)
  ...
  def counter_group_ctrl_snd_next()
    ...
    Firmware.log(string.format("MTR: .          Counter_group_ctrl_snd=%i", next), 3)
  ...
  def log_new_fabric()
    import string
    Firmware.log(string.format("MTR: +Fabric    fab='%s'", self.get_fabric_id().copy().reverse().tohex()), 2)
  end
  ...
  def before_remove()
    import string
    Firmware.log(string.format("MTR: -Fabric    fab='%s' (removed)", self.get_fabric_id().copy().reverse().tohex()), 2)
  end
