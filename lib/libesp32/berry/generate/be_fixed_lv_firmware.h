...
static be_define_const_map_slots(m_liblv_Firmware_map) {
    ...
    { be_const_key_weak(splash_init, 0), be_const_closure(lv_Firmware_splash_init_closure) },
    { be_const_key_weak(register_button_encoder, -1), be_const_func(lv0_register_button_encoder) },
    { be_const_key_weak(init, 7), be_const_closure(lv_Firmware_init_closure) },
    { be_const_key_weak(splash_remove, -1), be_const_closure(lv_Firmware_splash_remove_closure) },
    ...
    { be_const_key_weak(splash, 10), be_const_closure(lv_Firmware_splash_closure) },
};

static be_define_const_map(
    m_liblv_Firmware_map,
    13
);
...
BE_EXPORT_VARIABLE be_define_const_native_module(lv_Firmware);
