...
be_extern_native_module(lv_Firmware);
...
be_extern_native_class(Firmware);
...
be_extern_native_class(Firmware_log_reader);
...
BERRY_LOCAL bclass_array be_class_table = {
    ...
    &be_native_class(Firmware_log_reader),
#ifdef USE_LIGHT
