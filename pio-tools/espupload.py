...
# Default URL overwritten by [env] and/or [env:Firmware32_base] upload_port
HOST_URL = "otaserver/ota/upload-Firmware.php"
...
#  print(sys.argv[0:])
  ...
  if args.image.find("firmware.bin") != -1:
    ...
    # copy firmware.bin to Firmware.bin or Firmware32.bin
    # C:\tmp\.pioenvs\Firmware-theo\firmware.bin
    tname = os.path.normpath(os.path.dirname(args.image))
    # C:\tmp\.pioenvs\Firmware-theo\Firmware-theo.bin
