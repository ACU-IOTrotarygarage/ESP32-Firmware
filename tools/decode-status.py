...
"""
  decode-status.py - decode status for Firmware
...
a_setoption = [[
    ...
    "(Teleinfo) Enable Teleinfo + Firmware Energy device (0) or Teleinfo raw data only (1)",
...
a_features = [[
    ...
    "WEBSERVER_ADVERTISE","USE_EMULATION_HUE","MQTT_PUBSUBCLIENT","MQTT_FirmwareMQTT",
    ...
    "USE_Firmware_CLIENT","USE_HIH6","USE_HPMA","USE_TSL2591",
...
def StartDecode():
    print ("\n*** decode-status.py v12.4.0.5 by Theo Arends and Mahmoud Shams El-Din and Jacek Ziolkowski ***")
