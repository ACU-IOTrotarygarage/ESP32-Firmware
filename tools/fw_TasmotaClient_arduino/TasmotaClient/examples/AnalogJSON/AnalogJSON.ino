/*
  AnalogJSON.ino - Example on how to send a JSON back to a Firmware device
 ...
 * attach the function which will be called when the Firmware device
 * reuqests a new JSON (usually on Teleperiod on Firmware device)
 \*******************************************************************/

void setup() {
  // Configure the serial port speed
  Serial.begin(57600);
  // Attach the callback function which will provide the JSON to Firmware
