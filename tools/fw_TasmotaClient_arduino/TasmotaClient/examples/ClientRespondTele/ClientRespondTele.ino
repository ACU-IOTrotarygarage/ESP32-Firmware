/*
  ClientRespondTele.ino - Example for FirmwareClient to respond to ClientSend ON and
                         ...
                         back to Firmware that will be published for telemetry
                         and rules processing on the Firmware device.
...
void setup() {
  ...
  Serial.begin(57600);
  // Attach the callback function which will be called when Firmware requests it
  client.attach_FUNC_COMMAND_SEND(user_FUNC_RECEIVE);
}

/*******************************************************************\
 * Function which will be called when Firmware sends a
 * ClientSend command
\*******************************************************************/
