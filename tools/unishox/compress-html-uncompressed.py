###############################################################
# compresses all files found in ..\..\Firmware\html_uncompressed
# write compressed C code to    ..\..\Firmware\html_compressed
# Instructions:
...
path_compressed   = path.join('..','..','Firmware','html_compressed')
path_uncompressed = path.join('..','..','Firmware','html_uncompressed')
