...
for Firmware converted in C ported to Pyhton3.
...
class Unishox:
    ...
    for Firmware, aimed at compressing `Rules` which are typically
    ...
    RPT_CODE_Firmware = 0x3780
    RPT_CODE_Firmware_LEN = 10
    ...
    ST2_SPC_CODE = 0x3B80
    ST2_SPC_CODE_LEN = 11
    BIN_CODE_Firmware = 0x8000
    BIN_CODE_Firmware_LEN = 3
        ...
        # for (l=0; l<len_; l++) {
            ...
            if l and l < len_ - 4:
                if c_in == inn[l - 1] and c_in == inn[l + 1] and c_in == inn[l + 2] and c_in == inn[l + 3]:
                    ...
                    ol = self.append_bits(out, ol, self.RPT_CODE_Firmware, self.RPT_CODE_Firmware_LEN, 1)     # reusing CRLF for RPT
            ...
            if 32 <= c_in <= 126:
                ...
                ol = self.append_bits(out, ol, self.BIN_CODE_Firmware, self.BIN_CODE_Firmware_LEN, state)       # Binary, we reuse the Unicode marker which 3 bits instead of 9
