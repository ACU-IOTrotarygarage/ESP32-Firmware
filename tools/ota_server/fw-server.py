...
# coding=utf-8
"""
fw-server.py - firmware server for Firmware OTA upgrade
...
Instructions:
    Copy Firmware firmware binary files in 'fw' directory or
    specify a different directory with -f parameter.
    A set of prebuilt files can be downloaded by Firmware release page:
        https://github.com/arendst/Firmware/releases

    Configure your Firmware device with your fw-server URL:
