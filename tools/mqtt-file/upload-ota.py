...
"""
   upload-ota.py - Upload Firmware firmware file
...
mypassword = ""                        # Firmware MQTT password
mytopic = "demo"                       # Firmware MQTT topic
#myfile = "../../build_output/firmware/Firmware32.bin"   # Firmware esp32 firmware file name
myfile = "../../build_output/firmware/Firmware.bin.gz"  # Firmware esp8266 firmware file name
myfiletype = 1                         # Firmware firmware file type
...
file_chunk_size = 700                  # Default Firmware MQTT max message size
   ...
   if wait_for_ack():                  # We use Ack here
      ...
      if chunk:
         ...
         if use_base64:
            ...
            # Message length used by Firmware (FileTransferHeaderSize)
