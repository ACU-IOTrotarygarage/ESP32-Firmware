...
"""
  templates.py - template beautify TEMPLATES.md for Firmware
...
Instructions:
    Execute command to produce file TEMPLATE.md as found in the Firmware root folder
...
# Some values from support.ino and Firmware_templates.h
AGPIO = lambda x : x << 5
GPIO_NONE = 0
...
# Conversion table extracted from Firmware code
GPIO_CONVERT = [
  0x0000,
  0x04A0,
  0x04C0,
...
def gpio_convert(gpio):
  """Conversion as per https://Firmware.github.io/docs/Components/#gpio-conversion"""
  if gpio >= len(GPIO_CONVERT):
    return GPIO_USER
  return GPIO_CONVERT[gpio]

def adc0_convert(adc0):
  """Conversion as per https://Firmware.github.io/docs/Components/#adc-conversion"""
  adc0 = adc0 & 0x0F
  if 0 == adc0:
    return GPIO_NONE
  elif 8 == adc0:
...
def main():
  print ("\n*** templates.py v20201121 by Theo Arends and Mahmoud Shams El-Din and Barbudor ***")
  ...
  fout.write("<picture>\n")
  fout.write("  <source media=\"(prefers-color-scheme: dark)\" srcset=\"./tools/logo/Firmware_FullLogo_Vector_White.svg\">\n")
  fout.write("  <img alt=\"Logo\" src=\"./tools/logo/Firmware_FullLogo_Vector.svg\" align=\"right\" height=\"76\">\n")
  fout.write("</picture>\n")
  fout.write("\n")
  fout.write("# Templates\n")
  fout.write("\n")
  fout.write("Find below the available templates as of " + month + " " + year + ". More template information can be found in the [Firmware Device Templates Repository](http://blakadder.github.io/templates)\n")
