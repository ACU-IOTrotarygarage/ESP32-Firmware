/*
  xsns_05_ds18x20.ino - DS18x20 temperature sensor support for Firmware

  Copyright (C) 2021  Theo Arends and Mahmoud Shams El-Din and md5sum-as (https://github.com/md5sum-as)
...
void Ds18x20Show(bool json) {
  for (uint32_t i = 0; i < DS18X20Data.sensors; i++) {
    ...
    if (ds18x20_sensor[index].valid) {   // Check for valid temperature
      ...
      if (json) {
        if (Settings->flag5.ds18x20_mean) {
          if ((0 == FirmwareGlobal.tele_period) && ds18x20_sensor[index].numread) {
