/*
  xsns_37_rfsensor.ino - RF sensor receiver for Firmware
 ...
 *
 * Auteur             : Theo Arends and Mahmoud Shams El-Din
...
#ifdef USE_DOMOTICZ
          if ((0 == FirmwareGlobal.tele_period) && !sensor_once) {
