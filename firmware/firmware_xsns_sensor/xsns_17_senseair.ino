/*
  xsns_17_senseair.ino - SenseAir CO2 sensor support for Firmware
...
void SenseairInit(void)
{
  ...
  if (PinUsed(GPIO_SAIR_RX) && PinUsed(GPIO_SAIR_TX)) {
    SenseairModbus = new FirmwareModbus(Pin(GPIO_SAIR_RX), Pin(GPIO_SAIR_TX));
