/*
  xsns_86_tfminiplus.ino - TFmini Plus interface for Firmware

  Copyright (C) 2021  Raphael Breiting and Theo Arends and Mahmoud Shams El-Din
 ...
 *
 * Before connecting module to Firmware, please prepare module with
 ...
 * 7. When point 6 returned OK, than ready to connect to Firmware! :)
...
FirmwareSerial *TfmpSerial = nullptr;
...
void TfmpInit(void)
{
    if (!tfminiplus_sensor.ready)
    {
        ...
        {
            TfmpSerial = new FirmwareSerial(Pin(GPIO_TFMINIPLUS_RX), Pin(GPIO_TFMINIPLUS_TX), 1);
