/*
  xsns_57_tsl2591.ino - TSL2591 light sensor support for Firmware

  Copyright (C) 2021  Markus Bösling and Theo Arends and Mahmoud Shams El-Din
...
#ifdef USE_DOMOTICZ
      if (0 == FirmwareGlobal.tele_period) { DomoticzSensor(DZ_ILLUMINANCE, tsl2591_lux); }
#endif  // USE_DOMOTICZ
#ifdef USE_WEBSERVER
    } else {
