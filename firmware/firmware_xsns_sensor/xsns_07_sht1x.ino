/*
  xsns_07_sht1x.ino - SHT1x temperature and sensor support for Firmware
...
void ShtShow(bool json) {
  if (Sht1x.valid) {
    TempHumDewShow(json, (0 == FirmwareGlobal.tele_period), Sht1x.types, Sht1x.temperature, Sht1x.humidity);
  }
}
