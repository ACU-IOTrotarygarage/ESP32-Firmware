/*
  XSNS_95_cm1107.ino - CM1107(B) CO2 sensor support for Firmware
...
void CM11Init(void)
{
  ...
  if (PinUsed(GPIO_CM11_RXD) && PinUsed(GPIO_CM11_TXD)) {
    CM11Serial = new FirmwareSerial(Pin(GPIO_CM11_RXD), Pin(GPIO_CM11_TXD), 1);
