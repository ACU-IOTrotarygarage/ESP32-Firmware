/*
  xsns_71_VEML7700.ino - VEML7700 Ambient light intensity Sensor support for Firmware
...
#ifdef USE_DOMOTICZ
      if (0 == FirmwareGlobal.tele_period) DomoticzSensor(DZ_ILLUMINANCE, veml7700_sensor.lux_normalized);
#endif  // USE_DOMOTICZ
#ifdef USE_WEBSERVER
  } else {
