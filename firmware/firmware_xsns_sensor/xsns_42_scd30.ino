/*
  xsns_42_scd30.ino - SCD30 CO2 sensor support for Firmware
...
bool Xsns42(uint32_t function) {
  ...
  // https://github.com/arendst/Firmware/issues/15438 and datasheet (The boot-up time is < 2 s.)
/*
  if (FUNC_INIT == function) {
    Scd30Detect();
  }
*/
  if (!Scd30.init_once && (FUNC_EVERY_SECOND == function) && (FirmwareGlobal.uptime > 3)) {
