/*
  xsns_56_hpma.ino - Honeywell HPMA115S0 particle concentration sensor support for Firmware
...
void HpmaInit(void)
{
  ...
  if (PinUsed(GPIO_HPMA_RX) && PinUsed(GPIO_HPMA_TX)) {
    HpmaSerial = new FirmwareSerial(Pin(GPIO_HPMA_RX), Pin(GPIO_HPMA_TX), 1);
