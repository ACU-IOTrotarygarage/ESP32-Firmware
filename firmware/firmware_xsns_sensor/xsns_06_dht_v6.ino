/*
  xsns_06_dht.ino - DHTxx, AM23xx and SI7021 temperature and humidity sensor support for Firmware
 ...
 * 20211226 - https://github.com/arendst/Firmware/pull/14173
 * 20210524 - https://github.com/arendst/Firmware/issues/12180
 * 20200621 - https://github.com/arendst/Firmware/pull/7468#issuecomment-647067015
 * 20200313 - https://github.com/arendst/Firmware/issues/7717#issuecomment-585833243
\*********************************************************************************************/
...
//      delay(2);   // minimum 1ms
      delayMicroseconds(2000);                          // 20200621: See https://github.com/arendst/Firmware/pull/7468#issuecomment-647067015
      break;
  ...
  switch (Dht[sensor].type) {
    ...
    case GPIO_SI7021:                                   // iTead SI7021
    case GPIO_MS01:                                     // Sonoff MS01
      delayMicroseconds(30);                            // See: https://github.com/letscontrolit/ESPEasy/issues/1798 and 20210524: https://github.com/arendst/Firmware/issues/12180
      break;
  }
...
void DhtEverySecond(void) {
  if (!(FirmwareGlobal.uptime %4)) {  // Every 4 seconds
...
void DhtShow(bool json) {
  for (uint32_t i = 0; i < dht_sensors; i++) {
    if (GPIO_MS01 == Dht[i].type) {
      ...
      TempHumDewShow(json, ((0 == FirmwareGlobal.tele_period) && (0 == i)), Dht[i].stype, Dht[i].t, Dht[i].h);
    }
  }
}
