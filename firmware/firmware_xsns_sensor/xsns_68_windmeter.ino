/*
  xsns_68_windmeter.ino - Analog wind sensor support for Firmware

  Copyright (C) 2021  Matteo Albinola
  (inspired by great works of Thomas Eckerstorfer, Norbert Richter, Maarten Damen and Theo Arends and Mahmoud Shams El-Din)
