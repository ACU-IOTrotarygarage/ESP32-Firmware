/*
  xsns_30_mpr121.ino - MPR121 support for Firmware

  Copyright (C) 2021  Rene 'Renne' Bartsch and Theo Arends and Mahmoud Shams El-Din
 ...
 *  @version     $Id$
 *
 *  @link        https://github.com/arendst/Firmware/wiki/MPR121               \endlink
...
/**
 * @ingroup group1
 * Assign Firmware sensor model ID
 */
#define XSNS_30          30
 ...
 *
 * @param   struct  *pS       Struct with MPR121 status and data.
 * @param   byte    function  Firmware function ID.
 * @return  void
...
/**
 * The function Xsns30() interfaces Firmware with the driver.
 *
 ...
 * FUNC_WEB_SENSOR for displaying data in the Firmware web-interface
 *
 * @param   byte    function  Firmware function ID.
 * @return  bool           ???
 * @pre     None.
