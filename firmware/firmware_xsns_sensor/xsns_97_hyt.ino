/*
  xsns_97_hyt.ino - HYT I2C temperature and humidity sensor support for Firmware
...
void HYT_Show(bool json) {
  if (HYT.valid) {
    TempHumDewShow(json, (0 == FirmwareGlobal.tele_period), HYT.name, HYT.temperature, HYT.humidity);
  }
}
