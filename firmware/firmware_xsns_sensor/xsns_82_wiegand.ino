/*
  xsns_82_wiegand.ino - Support for Wiegand Interface 125kHz Rfid Tag Reader for Firmware

  Copyright (C) 2021  Sigurd Leuther and Theo Arends and Mahmoud Shams El-Din
 ...
 *  - fix 64-bit representation after removal of %llu support (Firmware does not support 64-bit decimal output specifier (%llu) saving 60k code)
