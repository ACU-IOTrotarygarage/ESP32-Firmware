/*
  xsns_51_rdm6300.ino - Support for RDM630(0) 125kHz NFC Tag Reader on Firmware
...
FirmwareSerial *RDM6300Serial = nullptr;
...
void RDM6300Init() {
  if (PinUsed(GPIO_RDM6300_RX)) {
    RDM6300Serial = new FirmwareSerial(Pin(GPIO_RDM6300_RX), -1, 1);
