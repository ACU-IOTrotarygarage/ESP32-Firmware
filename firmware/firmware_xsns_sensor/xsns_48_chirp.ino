/*
  xsns_48_chirp.ino - soil moisture sensor support for Firmware
  ...
  ---
  1.0.0.0 20190608  started   - further development by Christian Baars  - https://github.com/Staars/Sonoff-Firmware
