/*
  xsns_08_htu21.ino - HTU21 temperature and humidity sensor support for Firmware
...
{
  if (Htu.valid) {
    TempHumDewShow(json, (0 == FirmwareGlobal.tele_period), Htu.types, Htu.temperature, Htu.humidity);
  }
}
