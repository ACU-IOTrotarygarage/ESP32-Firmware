/*
  xsns_91_vindriktning.ino - IKEA vindriktning particle concentration sensor support for Firmware

  Copyright (C) 2021  Marcel Ritter and Theo Arends and Mahmoud Shams El-Din
...
FirmwareSerial *VindriktningSerial;
...
void VindriktningInit(void) {
  ...
  if (PinUsed(GPIO_VINDRIKTNING_RX)) {
    VindriktningSerial = new FirmwareSerial(Pin(GPIO_VINDRIKTNING_RX), -1, 1);
