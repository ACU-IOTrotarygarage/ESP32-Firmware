/*
  xsns_89_t67xx.ino - Telaire T6700 Series CO2 sensor support for Firmware
...
const char *T67XX::getStatusMsg(uint16_t sensorStatus)
{
  ...
  if (FirmwareGlobal.uptime < T67XX_MEASURE_DELAY)
  {
    return PSTR("WARMUP");
  }
...
{
  if ((FirmwareGlobal.uptime < T67XX_MEASURE_DELAY) || (FirmwareGlobal.uptime % T67XX_MEASURE_INTERVAL > 0))
  {
    return;
  }
