/*
  xsns_40_pn532.ino - Support for PN532 (HSU) NFC Tag Reader on Firmware

  Copyright (C) 2021  Andre Thomas, Theo Arends and Mahmoud Shams El-Din and md5sum-as (https://github.com/md5sum-as)
...
void PN532_Init(void) {
  if (PinUsed(GPIO_PN532_RXD) && PinUsed(GPIO_PN532_TXD)) {
    PN532_Serial = new FirmwareSerial(Pin(GPIO_PN532_RXD), Pin(GPIO_PN532_TXD), 1);
