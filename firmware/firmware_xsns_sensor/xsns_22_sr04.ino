/*
  xsns_22_sr04.ino - SR04 ultrasonic sensor support for Firmware

  Copyright (C) 2021  Nuno Ferreira and Theo Arends and Mahmoud Shams El-Din
...
FirmwareSerial* sonar_serial = nullptr;
...
void Sr04TModeDetect(void) {
  ...
  sonar_serial = new FirmwareSerial(sr04_echo_pin, sr04_trig_pin, 1);
...
void Sr04TReading(void) {
  if (FirmwareGlobal.uptime < 3) { return; }
