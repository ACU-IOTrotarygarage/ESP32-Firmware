/*
  xsns_55_hih_series.ino - Honeywell HIH series temperature and humidity sensor support for Firmware
...
void Hih6Detect(void)
{
  ...
  if (FirmwareGlobal.uptime < 2) { delay(20); } // Skip entering power on comand mode
  Hih6.type = Hih6Read();
  if (Hih6.type) {
...
{
  if (Hih6.valid) {
    TempHumDewShow(json, (0 == FirmwareGlobal.tele_period), Hih6.types, Hih6.temperature, Hih6.humidity);
  }
}
