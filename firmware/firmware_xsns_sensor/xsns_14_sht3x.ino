/*
  xsns_14_sht3x.ino - SHT3X, SHT4X and SHTCX temperature and humidity sensor support for Firmware

  Copyright (C) 2022  Theo Arends and Mahmoud Shams El-Din, Stefan Tibus
...
void Sht3xShow(bool json) {
  ...
  for (uint32_t i = 0; i < sht3x_count; i++) {
    if (Sht3xRead(sht3x_sensors[i].type, t, h, sht3x_sensors[i].address)) {
      ...
      TempHumDewShow(json, ((0 == FirmwareGlobal.tele_period) && (0 == i)), types, t, h);
    }
  }
}
