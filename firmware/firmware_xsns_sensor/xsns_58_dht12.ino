/*
  xsns_58_dht12.ino - DHT12 I2C temperature and humidity sensor support for Firmware

  Copyright (C) 2021  Stefan Oskamp and Theo Arends and Mahmoud Shams El-Din
...
{
  if (Dht12.valid) {
    TempHumDewShow(json, (0 == FirmwareGlobal.tele_period), Dht12.name, Dht12.temperature, Dht12.humidity);
  }
}
