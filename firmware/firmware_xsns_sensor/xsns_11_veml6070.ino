/*
  xsns_11_veml6070.ino - VEML6070 ultra violet light sensor support for Firmware
  ...
  1.0.0.1 20180925  tests     - all tests are done with 1x sonoff sv, 2x Wemos D1 (not the mini)
                    ...
                    added     - lots of information in one of the last postings in: https://github.com/arendst/Firmware/issues/3844
  ...
  ---
  1.0.0.0 20180912  started   - further development by mike2nl  - https://github.com/mike2nl/Sonoff-Firmware
...
#endif  // USE_VEML6070_SHOW_RAW
#ifdef USE_DOMOTICZ
  if (0 == FirmwareGlobal.tele_period) { DomoticzSensor(DZ_ILLUMINANCE, uvlevel); }
#endif  // USE_DOMOTICZ
#ifdef USE_WEBSERVER
  } else {
#ifdef USE_VEML6070_SHOW_RAW
