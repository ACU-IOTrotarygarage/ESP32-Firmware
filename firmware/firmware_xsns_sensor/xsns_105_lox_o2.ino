/*
  xsns_105_lox_o2.ino - Support for LuminOx Sealed Optical Oxygen Sensor on Firmware
...
FirmwareSerial *LOXSerial = nullptr;
...
void LOXInit()
{
  if (PinUsed(GPIO_LOX_O2_RX))
  {
    ...
    LOXSerial = new FirmwareSerial(Pin(GPIO_LOX_O2_RX), -1, 1);
