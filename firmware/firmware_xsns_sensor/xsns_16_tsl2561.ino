/*
  xsns_16_tsl2561.ino - TSL2561 light sensor support for Firmware

  Copyright (C) 2021  Theo Arends and Mahmoud Shams El-Din and Joachim Banzhaf
...
{
  if (!(FirmwareGlobal.uptime %2)) {  // Every 2 seconds
    // ?mS - 4Sec
    if (!Tsl2561Read()) {
...
#ifdef USE_DOMOTICZ
      if (0 == FirmwareGlobal.tele_period) { DomoticzSensor(DZ_ILLUMINANCE, (tsl2561_milliLux + 500) / 1000); }
#endif  // USE_DOMOTICZ
#ifdef USE_WEBSERVER
    } else {
