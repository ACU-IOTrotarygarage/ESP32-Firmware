/*
  xsns_94_hdc2010.ino - Texas Instruments HDC1080 temperature and humidity sensor support for Firmware
...
void Hdc2010Show(bool json) {
  if (HDC2010.hdc_valid) {
    TempHumDewShow(json, (0 == FirmwareGlobal.tele_period), HDC2010.hdc_type_name, HDC2010.hdc_temperature, HDC2010.hdc_humidity);
  }
}
