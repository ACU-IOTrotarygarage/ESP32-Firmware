/*
  xsns_62_MI_HM10.ino - MI-BLE-sensors via HM-10 support for Firmware
...
void HM10SerialInit(void) {
  ...
  HM10Serial = new FirmwareSerial(Pin(GPIO_HM10_RX), Pin(GPIO_HM10_TX), 1, 0, HM10_MAX_RX_BUF);
