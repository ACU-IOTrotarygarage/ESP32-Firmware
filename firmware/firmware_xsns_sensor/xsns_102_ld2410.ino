/*
  xsns_102_ld2410.ino - HLK-LD2410 24GHz smart wave motion sensor support for Firmware
...
FirmwareSerial *LD2410Serial = nullptr;
...
/*
  // Works with FirmwareSerial as SoftwareSerial but fails with HardwareSerial
...
*/
  // Works with FirmwareSerial and HardwareSerial
...
void Ld2410Detect(void) {
  if (PinUsed(GPIO_LD2410_RX) && PinUsed(GPIO_LD2410_TX)) {
    ...
    LD2410Serial = new FirmwareSerial(Pin(GPIO_LD2410_RX), Pin(GPIO_LD2410_TX), 2);
