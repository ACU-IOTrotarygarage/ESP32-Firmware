/*
  xsns_02_analog.ino - ADC support for Firmware
    ...
    switch (Adc[idx].type) {
      ...
      case ADC_TEMP: {
        if (json) {
          ...
          if ((0 == FirmwareGlobal.tele_period) && (!domo_flag[ADC_TEMP])) {
#ifdef USE_DOMOTICZ
...
#ifdef USE_DOMOTICZ
          if ((0 == FirmwareGlobal.tele_period) && (!domo_flag[ADC_LIGHT])) {
...
#ifdef USE_DOMOTICZ
          if ((0 == FirmwareGlobal.tele_period) && (!domo_flag[ADC_CT_POWER])) {
