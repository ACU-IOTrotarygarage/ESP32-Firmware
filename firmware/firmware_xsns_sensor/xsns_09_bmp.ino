/*
  xsns_09_bmp.ino - BMP pressure, temperature, humidity and gas sensor support for Firmware
 ...
 * BMP280 and BME280
 *
 * Programmer : BMP280/BME280 Datasheet and Adafruit with changes by Theo Arends and Mahmoud Shams El-Din
\*********************************************************************************************/
...
#ifdef ESP32
        if (FirmwareGlobal.i2c_enabled_2) {           // Second bus enabled
...
#ifdef USE_DOMOTICZ
        if ((0 == FirmwareGlobal.tele_period) && (0 == bmp_idx)) {  // We want the same first sensor to report to Domoticz in case a read is missed
