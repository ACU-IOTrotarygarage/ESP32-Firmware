/*
  xsns_88_am2320.ino - I2C AM2320 Temp/Hum Sensor for Firmware
 ...
 * and https://github.com/nightphobos/Firmware-am2320-i2c-driver as adaptation code to Tamota
\*********************************************************************************************/
...
void Am2320Show(bool json)
{
  if (AM2320.valid) {
    ...
    TempHumDewShow(json, (0 == FirmwareGlobal.tele_period), AM2320_types, t, h);
  }
}
