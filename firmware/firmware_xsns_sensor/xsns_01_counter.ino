/*
  xsns_01_counter.ino - Counter sensors (water meters, electricity meters etc.) sensor support for Firmware

  Copyright (C) 2021  Maarten Damen and Theo Arends and Mahmoud Shams El-Din
...
#endif  // USE_DOMOTICZ
        if ((0 == FirmwareGlobal.tele_period ) && (Settings->flag3.counter_reset_on_tele)) {
