...
```
## Firmware default embedded register names
```
...
```
  User          - Additional user defined registers
                  ...
                  F - Register factor positive for multiplication or negative for division - optional. default is 0 - no action
                      ...
                      3 - multiply by 1000
                      4 - multiply by 10000
                  J - JSON register name (preferrably without spaces like "PhaseAngle") - mandatory. It needs to be different from the Firmware default embedded register names
                  ...
                  D - Number of decimals for floating point presentation (0 to 20) or a code correspondig to Firmware resolution command settings:
                      21 - VoltRes (V)
                      22 - AmpRes (A)
                      23 - WattRes (W, VA, VAr)
