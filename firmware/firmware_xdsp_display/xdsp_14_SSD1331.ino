/*
  xdsp_14_SSD1331.ino - Display SSD1331 support for Firmware

  Copyright (C) 2021  Jeroen Vermeulen, Gerhard Mutz and Theo Arends and Mahmoud Shams El-Din
...
void SSD1331_InitDriver() {
  if (PinUsed(GPIO_SSD1331_CS) && PinUsed(GPIO_SSD1331_DC) &&
     ((FirmwareGlobal.soft_spi_enabled & SPI_MOSI) || (FirmwareGlobal.spi_enabled & SPI_MOSI))) {
    ...
    else if (FirmwareGlobal.spi_enabled) {
