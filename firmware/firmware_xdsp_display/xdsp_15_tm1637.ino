/*
  xdsp_15_tm1637.ino - Support for TM1637- and TM1638-based seven-segment displays for Firmware
...
/*********************************************************************************************\
  ...
  To use, compile Firmware with USE_DISPLAY and USE_DISPLAY_TM1637, or build the Firmware-display env.
