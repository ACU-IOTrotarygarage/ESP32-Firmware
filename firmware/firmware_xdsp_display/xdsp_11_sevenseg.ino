/*
  xdsp_11_sevenseg.ino - Display seven segment support for Firmware

  Copyright (C) 2021  Theo Arends and Mahmoud Shams El-Din and Adafruit
...
void SevensegInitDriver(void) {
  if (!FirmwareGlobal.i2c_enabled) { return; }
