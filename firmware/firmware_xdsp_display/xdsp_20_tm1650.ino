/*
  xdsp_20_tm1650.ino - TM1650 four-digit seven-segment LED display controller support for Firmware

  Copyright (C) 2021  Stefan Oskamp, Theo Arends and Mahmoud Shams El-Din, Anatoli Arkhipenko
...
/*********************************************************************************************\
  ...
  To use, compile Firmware with USE_I2C, USE_DISPLAY and USE_DISPLAY_TM1650, or build the Firmware-display env.

  For TM1650:
  Connect the TM1650 display module's pins to any free GPIOs of the ESP8266 module
  and assign the pins as follows from Firmware's GUI:
  ...
  if (Settings->display_mode) {  // Mode 0 is User text
    switch (Settings->display_mode) {
      ...
      case 2:  // Date
        ...
        break;
      case 3: // Time/Date
        if (FirmwareGlobal.uptime % Settings->display_refresh)
        {
          TM1650Time();
        }
        else
