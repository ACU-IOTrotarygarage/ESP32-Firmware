/*
  support_features.ino - feature support for Firmware
...
#endif
#ifdef USE_LIGHT
    feature1 |= 0x00000002;  // Firmware.ino, xdrv_04_light.ino
#endif
#ifdef USE_I2C
    feature1 |= 0x00000004;  // Firmware.ino
#endif
#ifdef USE_SPI
    feature1 |= 0x00000008;  // Firmware.ino
#endif
#ifdef USE_DISCOVERY
    feature1 |= 0x00000010;  // Firmware.ino
#endif
#ifdef USE_ARDUINO_OTA
    feature1 |= 0x00000020;  // Firmware.ino
#endif
#ifdef USE_MQTT_TLS
...
//#endif
//#if (MQTT_LIBRARY_TYPE == MQTT_FirmwareMQTT)
...
//#endif
  ...
  if (!feature5) {           // Only fill this once
    ...
    feature5 |= 0x00010000;  // xdrv_31_Firmware_client.ino
#endif
