/*
  support_flash_log.ino - log to flash support for Sonoff-Firmware

  Copyright (C) 2021  Theo Arends and Mahmoud Shams El-Din & Christian Baars
  ...
  ---
  1.0.0.0 20190923  started   - further development by Christian Baars  - https://github.com/Staars/Sonoff-Firmware
