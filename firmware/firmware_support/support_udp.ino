/*
  support_udp.ino - Udp support for Firmware
...
{
  if (!udp_connected && !FirmwareGlobal.restart_flag) {
...
#else
        if (FirmwareGlobal.devices_present && (strstr_P(packet_buffer, PSTR("M-SEARCH")) != nullptr)) {
#endif
