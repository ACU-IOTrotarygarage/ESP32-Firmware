/*
  Firmware_ca.ino - Certificate authorities for Firmware, LetsEncrypt and AWS
...
//
// See the files Firmware/local_ca_data_sample.h and Firmware/local_ca_descriptor_sample.h
// in the Firmware source for instructions for generating them from a local root
...
//  ========== cumulative CA =================
//
const br_x509_trust_anchor PROGMEM Firmware_TA[] = {
#if ! defined(OMIT_LETS_ENCRYPT_CERT)
	{
...
const size_t Firmware_TA_size = nitems(Firmware_TA);
