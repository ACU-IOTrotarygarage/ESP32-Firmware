/*
  xlgt_09_sm2335.ino - sm2335 five channel led support for Firmware

  Copyright (C) 2021  Theo Arends and Mahmoud Shams El-Din and Cossid
...
void SM2335ModuleSelected(void)
{
  if (PinUsed(GPIO_SM2335_CLK) && PinUsed(GPIO_SM2335_DAT, GPIO_ANY)) {
    ...
    // See #define MAX_SM2335_DAT 16 in Firmware_template.h
    ...
    FirmwareGlobal.light_driver = XLGT_09;
