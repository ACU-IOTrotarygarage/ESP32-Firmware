/*
  xlgt_04_sm2135.ino - sm2135 five channel led support for Firmware

  Copyright (C) 2021  Theo Arends and Mahmoud Shams El-Din and CrudelisPL
...
void Sm2135ModuleSelected(void)
{
  if (PinUsed(GPIO_SM2135_CLK) && PinUsed(GPIO_SM2135_DAT, GPIO_ANY)) {
    ...
    // See #define MAX_SM2135_DAT 10 in Firmware_template.h
    ...
    Sm2135.current = (SM2135_20MA << 4) | SM2135_15MA;  // See https://github.com/arendst/Firmware/issues/6495#issuecomment-549121683
    switch (Sm2135.model) {
    ...
    FirmwareGlobal.light_driver = XLGT_04;
