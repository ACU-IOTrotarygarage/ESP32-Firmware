/*
  xlgt_06_moodlamp.ino - ElectriQ iQ-wifiMOODL LED support for Firmware

  Copyright (C) 2021  ianbyte and Theo Arends and Mahmoud Shams El-Din
...
void ElectriqMoodLModuleSelected(void)
{
  if (PinUsed(GPIO_ELECTRIQ_MOODL_TX)) {
    ...
    FirmwareGlobal.light_driver = XLGT_06;
