/*
  xlgt_10_bp1658cj.ino - bp1658cj five channel led support for Firmware

  Copyright (C) 2022  Theo Arends and Mahmoud Shams El-Din and Cossid
...
void BP1658CJModuleSelected(void)
{
  if (PinUsed(GPIO_BP1658CJ_CLK) && PinUsed(GPIO_BP1658CJ_DAT, GPIO_ANY)) {
    ...
    // See #define MAX_BP1658CJ_DAT 16 in Firmware_template.h
    ...
    FirmwareGlobal.light_driver = XLGT_10;
