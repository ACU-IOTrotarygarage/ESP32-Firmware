/*
  xlgt_01_ws2812.ino - led string support for Firmware
...
void Ws2812DDP(void)
{
  ...
  if (FirmwareGlobal.restart_flag || FirmwareGlobal.global_state.network_down) return;
...
void Ws2812ShowScheme(void)
{
  ...
  switch (scheme) {
    case 0:  // Clock
      if ((1 == FirmwareGlobal.state_250mS) || (Ws2812.show_next)) {
        Ws2812Clock();
        Ws2812.show_next = 0;
      }
      break;
...
#endif
    FirmwareGlobal.light_driver = XLGT_01;
  }
}
