/*
  xlgt_11_pca9632.ino - pca9632 four channel led support for Firmware
...
bool PCA9632_ModuleSelected(void) {
  ...
  if (PCA9632_Detect()) {
    ...
    FirmwareGlobal.light_type += LST_RGBW;    // Add RGBW to be controlled by PCA9632
    FirmwareGlobal.light_driver = XLGT_11;
