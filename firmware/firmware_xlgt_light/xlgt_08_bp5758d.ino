/*
  xlgt_08_bp5758d.ino - bp5758d five channel led support for Firmware

  Copyright (C) 2022  Theo Arends and Mahmoud Shams El-Din and oomg
...
void Bp5758dModuleSelected(void)
{
  if (PinUsed(GPIO_BP5758D_CLK) && PinUsed(GPIO_BP5758D_DAT)) {
    ...
    FirmwareGlobal.light_driver = XLGT_08;
