/*
  Firmware_configurations.h - Configurations for Firmware
...
#ifndef _Firmware_CONFIGURATIONS_H_
#define _Firmware_CONFIGURATIONS_H_
...
//#define USE_Firmware_CLIENT                       // Add support for Arduino Uno/Pro Mini via serial interface including flashing (+2k3 code, 44 mem)
...
#undef USE_Firmware_CLIENT                        // Disable support for Arduino Uno/Pro Mini via serial interface including flashing (+2k3 code, 44 mem)
...
#undef MODULE
#define MODULE                 SONOFF_ZB_BRIDGE  // [Module] Select default module from Firmware_template.h
...
#undef FIRMWARE_LITE                             // Disable Firmware-lite with no sensors
#undef FIRMWARE_SENSORS                          // Disable Firmware-sensors with useful sensors enabled
#undef FIRMWARE_KNX_NO_EMULATION                 // Disable Firmware-knx with KNX but without Emulation
#undef FIRMWARE_DISPLAYS                         // Disable Firmware-display with display drivers enabled
#undef FIRMWARE_IR                               // Disable Firmware-ir with IR full protocols activated

#undef USE_IMPROV                                // Disable support for IMPROV serial protocol as used by esp-web-tools (+2k code)
#undef USE_TASMESH                               // Disable Firmware Mesh using ESP-NOW (+11k code)
#undef USE_ARDUINO_OTA                           // Disable support for Arduino OTA
#undef USE_INFLUXDB                              // Disable influxdb support (+5k code)
#undef USE_DOMOTICZ                              // Disable Domoticz
#undef USE_HOME_ASSISTANT                        // Disable Home Assistant
#undef USE_Firmware_DISCOVERY                     // Disable Firmware Discovery support (+2k code)
...
#ifdef ESP32
#include "Firmware_configurations_ESP32.h"
#endif  // ESP32
...
// IR_SEND has two mode: minimal or full (USE_IR_REMOTE_FULL)
  ...
  #endif
  // PRONTO protocol cannot be supported because it requires specific APIs which are not supported in Firmware
...
#ifdef USE_Firmware_SLAVE
#define USE_Firmware_CLIENT
#endif
#ifdef USE_Firmware_SLAVE_FLASH_SPEED
#define USE_Firmware_CLIENT_FLASH_SPEED USE_Firmware_SLAVE_FLASH_SPEED
#endif
#ifdef USE_Firmware_SLAVE_SERIAL_SPEED
#define USE_Firmware_CLIENT_SERIAL_SPEED USE_Firmware_SLAVE_SERIAL_SPEED
#endif
...
#ifndef CODE_IMAGE_STR
  #define CODE_IMAGE_STR "Firmware"
#endif

#endif  // _Firmware_CONFIGURATIONS_H_
