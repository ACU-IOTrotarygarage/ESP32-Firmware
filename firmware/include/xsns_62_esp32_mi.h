/*
  xsns_62_esp32_mi.h - MI-BLE-sensors via ESP32 support for Firmware
...
const char kMI32_ButtonMsg[] PROGMEM = "Single|Double|Hold"; //mapping: in Firmware: 1,2,3 ; for HomeKit and Xiaomi 0,1,2
/*********************************************************************************************\
 * enumerations
\*********************************************************************************************/
