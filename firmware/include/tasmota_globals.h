/*
  Firmware_globals.h - Function prototypes and global configurations for Firmware
...
#ifndef _Firmware_GLOBALS_H_
#define _Firmware_GLOBALS_H_
...
#include "include/Firmware_configurations.h"            // Preconfigured configurations
