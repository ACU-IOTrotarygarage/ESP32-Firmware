/*
  Firmware_template_legacy.h - template settings for Firmware
...
#ifndef _Firmware_TEMPLATE_LEGACY_H_
#define _Firmware_TEMPLATE_LEGACY_H_
...
enum LegacyUserSelectablePins {
  ...
  GPI8_FirmwareCLIENT_TXD,     // Client TX
  GPI8_FirmwareCLIENT_RXD,     // Client RX
  GPI8_FirmwareCLIENT_RST,     // Client Reset Pin
  GPI8_FirmwareCLIENT_RST_INV, // Client Reset Inverted
...
#endif  // _Firmware_TEMPLATE_LEGACY_H_
