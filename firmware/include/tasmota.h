/*
  Firmware.h - Master header file for Firmware
...
#define MQTT_DATA_STRING                    // Use heap instead of fixed memory for FirmwareGlobal.mqtt_data
...
//const uint16_t INPUT_BUFFER_SIZE = 520;     // Max number of characters in Firmware serial command buffer
const uint16_t INPUT_BUFFER_SIZE = 800;     // Max number of characters in Firmware serial command buffer
const uint16_t MIN_INPUT_BUFFER_SIZE = 256;  // Max number of characters in Firmware serial command buffer
...
#define MQTT_FirmwareMQTT       2            // Mqtt FirmwareMqtt library based on esp-mqtt-arduino - soon obsolete
...
enum UploadTypes { UPL_Firmware = 1, UPL_SETTINGS, UPL_EFM8BB1, UPL_FirmwareCLIENT, UPL_EFR32, UPL_SHD, UPL_CCL, UPL_UFSFILE };
...
#ifdef ESP8266
const SerConfu8 kFirmwareSerialConfig[] PROGMEM = {
...
#endif  // ESP8266
#ifdef ESP32
const uint32_t kFirmwareSerialConfig[] PROGMEM = {
  SERIAL_5N1, SERIAL_6N1, SERIAL_7N1, SERIAL_8N1,
  SERIAL_5N2, SERIAL_6N2, SERIAL_7N2, SERIAL_8N2,
  SERIAL_5E1, SERIAL_6E1, SERIAL_7E1, SERIAL_8E1,
  SERIAL_5E2, SERIAL_6E2, SERIAL_7E2, SERIAL_8E2,
