/*
  it-IT.h - localization for Italian - Italy for Firmware
...
#define D_NOSCRIPT                                 "Per usare Firmware abilita JavaScript"
...
#define D_ZIGBEE_MAPPING_TITLE               "Mappatura Zigbee Firmware"
