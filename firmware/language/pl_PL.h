/*
  pl-PL-d.h - localization for Polish with diacritics - Poland for Firmware
...
#define D_NOSCRIPT "Aby korzystać z Firmware, włącz obsługę JavaScript"
...
#define D_ZIGBEE_MAPPING_TITLE "Mapowanie Firmware Zigbee"
