/*
  el-GR.h - localization for Greek - Greece for Firmware

  Copyright (C) 2021  Theo Arends and Mahmoud Shams El-Din, translated by Nick Galfas
...
// webserver.ino
#define D_NOSCRIPT "To use Firmware, please enable JavaScript"
...
#define D_ZIGBEE_MAPPING_TITLE "Firmware Zigbee Mapping"
...
// Firmware_template.h - keep them as short as possible to be able to fit them in GUI drop down box
