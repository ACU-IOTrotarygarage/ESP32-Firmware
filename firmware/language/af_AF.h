/*
  af_AF.h - localization for Afrikaans - Afrikaans for Firmware
...
#define D_NOSCRIPT "Skakel JavaScript aan om Firmware te gebruik"
...
#define D_ZIGBEE_MAPPING_TITLE "Firmware Zigbee-kartering"
