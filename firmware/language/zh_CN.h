/*
  zh-CN.h - localization for Chinese (Simplified) - China for Firmware
...
// webserver.ino
#define D_NOSCRIPT "Firmware 要求浏览器支持 JavaScript"
...
#define D_ZIGBEE_MAPPING_TITLE "Firmware Zigbee 映射"
