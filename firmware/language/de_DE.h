/*
  de-DE.h - localization for German - Germany for Firmware
...
#define D_NOSCRIPT "JavaScript aktivieren um Firmware benutzen zu können"
...
#define D_PROGRAM_VERSION "Firmware Version"
...
#define D_ZIGBEE_MAPPING_TITLE "Firmware Zigbee Karte"
