/*
  fr-FR.h - localization for French - France for Firmware
...
#define D_NOSCRIPT "Pour utiliser Firmware, veuillez activer JavaScript"
...
#define D_ZIGBEE_MAPPING_TITLE "Cartographie Firmware ZigBee"
