/*
  pt-PT.h - localization for Portuguese - Portugal for Firmware
...
#define D_NOSCRIPT "Para utilizar o Firmware, por favor ative o JavaScript"
...
#define D_ZIGBEE_MAPPING_TITLE "Mapeamento Firmware Zigbee"
