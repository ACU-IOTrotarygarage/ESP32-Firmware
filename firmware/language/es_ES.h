/*
  es-ES.h - Firmware localization for Spanish (International Spanish valid for all latinamerica)
...
#define D_NOSCRIPT "Habilitar JavaScript para usar Firmware"
...
#define D_ZIGBEE_MAPPING_TITLE "Mapeo de Firmware Zigbee"
