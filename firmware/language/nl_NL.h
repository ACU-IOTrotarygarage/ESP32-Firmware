/*
  nl-NL.h - localization for Dutch - Nederland for Firmware
...
#define D_NOSCRIPT "Zet JavaScript aan voor Firmware"
...
#define D_ZIGBEE_MAPPING_TITLE "Firmware Zigbee Overzicht"
