/*
  pt-BR.h - localization for Portuguese - Brazil for Firmware
...
#define D_NOSCRIPT "Para usar o Firmware, por favor habilite o  JavaScript"
...
#define D_ZIGBEE_MAPPING_TITLE "Mapeamento Firmware Zigbee" // "Firmware Zigbee Mapping"
