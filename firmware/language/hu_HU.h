/*
  hu-HU.h - localization for Hungarian in Hungary for Firmware
...
#define D_NOSCRIPT "A Firmware használatához engedélyezd a Javascriptet!"
...
#define D_ZIGBEE_MAPPING_TITLE "Firmware Zigbee leképezés"
