/*
  xsns_56_rtc_chips.ino - RTC chip support for Firmware
...
void RtcChipEverySecond(void) {
  ...
  if (FirmwareGlobal.global_state.network_down) { return; }  // Exception on ESP32 if network is down (#17338)
...
void CmndRtcNtpServer(void) {
  ...
  if ((XdrvMailbox.payload >= 0) && !FirmwareGlobal.global_state.network_down) {
