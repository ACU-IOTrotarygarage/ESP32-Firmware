/*
  xdrv_52_3_berry_Firmware.ino - Berry scripting language, native fucnctions
 ...
 * import Firmware
 *
 * Firmware.get_free_heap() -> int
 * Firmware.publish(topic:string, payload:string[, retain:bool]) -> nil
 * Firmware.cmd(command:string) -> string
 * Firmware.get_option(index:int) -> int
 * Firmware.millis([delay:int]) -> int
 * Firmware.time_reached(timer:int) -> bool
 * Firmware.yield() -> nil
 *
 * Firmware.get_light([index:int = 0]) -> map
 * Firmware.get_power([index:int = 0]) -> bool
 * Firmware.set_power(idx:int, power:bool) -> bool or nil
 * Firmware.set_light(idx:int, values:map) -> map
 *
\*********************************************************************************************/
extern "C" {
  // Berry: `Firmware.publish_result(payload:string, subtopic:string) -> nil``
  //
  ...
  // Berry: `Firmware.publish_rulet(payload:string) -> bool``
  //
  ...
  // Berry: `Firmware.cmd(command:string) -> string`
  //
  ...
  // Berry: Firmware.millis([delay:int]) -> int
  //
  ...
  // Berry: Firmware.get_option(index:int) -> int
  //
  ...
  // Berry: Firmware.time_reached(timer:int) -> bool
  //
  ...
  // Berry: Firmware.hostname() -> string
  //
  ...
  // Berry: Firmware.delay(timer:int) -> nil
  //
  ...
  // Berry: Firmware.delay_microseconds(timer:int) -> nil
  //
  ...
  // Berry: Firmware.scale_uint(int * 5) -> int
  //
  ...
  assert(Firmware._find_op("aaa#bbc==23") == 0x80007)
  assert(Firmware._find_op("az==23") == 0x30002)
  assert(Firmware._find_op("a>23") == 0x10001)
  assert(Firmware._find_op("aaa#bbc!23") == -1)
  ...
  */
  ...
  # unit tests
  # equals
  assert(Firmware._apply_str_op(1, "aa", "AA") == true)
  assert(Firmware._apply_str_op(1, "aa", "AAA") == false)
  assert(Firmware._apply_str_op(1, "a", "AA") == false)
  assert(Firmware._apply_str_op(1, "", "AA") == false)
  assert(Firmware._apply_str_op(1, "aa", "") == false)
  assert(Firmware._apply_str_op(1, "", "") == true)

  # not equals
  assert(Firmware._apply_str_op(2, "aa", "AA") == false)
  assert(Firmware._apply_str_op(2, "aa", "AAA") == true)
  assert(Firmware._apply_str_op(2, "a", "AA") == true)
  assert(Firmware._apply_str_op(2, "", "AA") == true)
  assert(Firmware._apply_str_op(2, "aa", "") == true)
  assert(Firmware._apply_str_op(2, "", "") == false)

  # starts with
  assert(Firmware._apply_str_op(3, "aabbcc", "AA") == true)
  assert(Firmware._apply_str_op(3, "aaabbcc", "AA") == true)
  assert(Firmware._apply_str_op(3, "abbaacc", "AA") == false)
  assert(Firmware._apply_str_op(3, "aabbcc", "a") == true)
  assert(Firmware._apply_str_op(3, "aabbcc", "") == true)
  assert(Firmware._apply_str_op(3, "", "") == true)
  assert(Firmware._apply_str_op(3, "", "a") == false)

  assert(Firmware._apply_str_op(3, "azeaze", "az") == true)
  assert(Firmware._apply_str_op(3, "azeaze", "ze") == false)

  # ends with
  assert(Firmware._apply_str_op(4, "azeaze", "az") == false)
  assert(Firmware._apply_str_op(4, "azeaze", "ze") == true)
  assert(Firmware._apply_str_op(4, "azeaze", "") == true)
  assert(Firmware._apply_str_op(4, "", "aa") == false)
  assert(Firmware._apply_str_op(4, "aa", "aa") == true)
  assert(Firmware._apply_str_op(4, "aabaa", "aa") == true)

  # contains
  assert(Firmware._apply_str_op(5, "azeaze", "az") == true)
  assert(Firmware._apply_str_op(5, "azeaze", "ze") == true)
  assert(Firmware._apply_str_op(5, "azeaze", "") == true)
  assert(Firmware._apply_str_op(5, "azeaze", "e") == true)
  assert(Firmware._apply_str_op(5, "azeaze", "a") == true)
  assert(Firmware._apply_str_op(5, "azeaze", "z") == true)
  assert(Firmware._apply_str_op(5, "azertyuiop", "tyui") == true)
  assert(Firmware._apply_str_op(5, "azertyuiop", "azr") == false)
  assert(Firmware._apply_str_op(5, "", "aze") == false)

  # not contains
  assert(Firmware._apply_str_op(6, "azeaze", "az") == false)
  assert(Firmware._apply_str_op(6, "azeaze", "ze") == false)
  assert(Firmware._apply_str_op(6, "azeaze", "") == false)
  assert(Firmware._apply_str_op(6, "azeaze", "e") == false)
  assert(Firmware._apply_str_op(6, "azeaze", "a") == false)
  assert(Firmware._apply_str_op(6, "azeaze", "z") == false)
  assert(Firmware._apply_str_op(6, "azertyuiop", "tyui") == false)
  assert(Firmware._apply_str_op(6, "azertyuiop", "azr") == true)
  assert(Firmware._apply_str_op(6, "", "aze") == true)
  ...
  */
  ...
  int32_t l_getpower(bvm *vm) {
    power_t pow = FirmwareGlobal.power;
    int32_t top = be_top(vm); // Get the number of arguments
    if (top >= 2 && be_isint(vm, 2)) {
      int32_t idx = be_toint(vm, 2);
      if (idx >= 0 && idx < FirmwareGlobal.devices_present) {
...
extern "C" {
  ...
  void Firmware_log_C(int32_t loglevel, const char * berry_buf, ...) {
    va_list arg;
    va_start(arg, berry_buf);
