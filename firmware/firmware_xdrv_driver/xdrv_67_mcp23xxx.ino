/*
  xdrv_67_mcp23xxx.ino - MCP23008/MCP23017/MCP23S17 GPIO Expander support for Firmware

  SPDX-FileCopyrightText: 2023 Theo Arends and Mahmoud Shams El-Din
 ...
 *
 * The goal of the driver is to provide a sequential list of pins configured as Firmware template
...
void MCP23xModuleInit(void) {
...
#ifdef USE_SPI
  if ((SPI_MOSI_MISO == FirmwareGlobal.spi_enabled) && PinUsed(GPIO_MCP23SXX_CS, GPIO_ANY)) {
#ifdef ESP8266
    SPI.begin();
#endif
#ifdef ESP32
  ...
  Mcp23x.relay_offset = FirmwareGlobal.devices_present;
...
#ifdef USE_SPI
  spi_enabled = (SPI_MOSI_MISO == FirmwareGlobal.spi_enabled);
#endif  // USE_SPI
#ifdef USE_I2C
