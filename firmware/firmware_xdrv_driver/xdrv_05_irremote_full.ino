/*
  xdrv_05_irremote_full.ino - complete integration of IRremoteESP8266 for Firmware

  Copyright (C) 2021  Heiko Krupp, Lazar Obradovic, Theo Arends and Mahmoud Shams El-Din, Stephan Hadinger
...
stdAc::state_t irac_prev_state; // this implementations only keeps one state so if you use a single Firmware-ir device to command more than one AC it might not work
