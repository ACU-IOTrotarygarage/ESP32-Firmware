/*
    xdrv_45_shelly_dimmer.ino - shelly dimmer support for Firmware
...
FirmwareSerial *ShdSerial = nullptr;
...
void ShdInit(void)
{
    ...
    {
        ShdSerial = new FirmwareSerial(Pin(GPIO_RXD), Pin(GPIO_TXD), 2, 0, SHD_BUFFER_SIZE);
...
bool Xnrg31(uint32_t function) {
  ...
  if (Shd.present) {
    if (FUNC_PRE_INIT == function) {
      ...
      FirmwareGlobal.energy_driver = XNRG_31;
    }
  }
  return result;
}
