/*
  xdrv_40_telegram.ino - telegram for Firmware
...
void TelegramSendGetMe(void) {
  ...
  // {"ok":true,"result":{"id":1179906608,"is_bot":true,"first_name":"Firmware","username":"Firmware_bot","can_join_groups":true,"can_read_all_group_messages":false,"supports_inline_queries":false}}
...
void TelegramLoop(void) {
  if (!FirmwareGlobal.global_state.network_down && (Settings->sbflag1.telegram_recv_enable || Settings->sbflag1.telegram_echo_enable)) {
