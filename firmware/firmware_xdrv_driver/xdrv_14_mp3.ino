/*
  xdrv_14_mp3.ino - MP3 support for Firmware

  Copyright (C) 2021  gemu2015, mike2nl and Theo Arends and Mahmoud Shams El-Din
  ...
  ---
  0.9.0.1 20180905  added   - #include <FirmwareSerial.h> because compiler error (Arduino IDE v1.8.5)
  ---
  0.9.0.0 20180901  started - further development by mike2nl  - https://github.com/mike2nl/Sonoff-Firmware
                    base    - code base from gemu2015 ;-)     - https://github.com/gemu2015/Sonoff-Firmware
                    forked  - from arendst/Firmware            - https://github.com/arendst/Firmware


                  Ver 12.1.0.4x
                  /include/Firmware/Firmware_template.h
                  @ line 56
...
{
  MP3Player = new FirmwareSerial(-1, Pin(GPIO_MP3_DFR562));
