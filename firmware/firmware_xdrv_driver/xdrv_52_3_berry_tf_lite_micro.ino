 ...
 *        Used to log from Tensorflow and from this (Firmware) driver
 * 
...
/**
 * @brief Init I2S microphone. Pins must be configured in the "usual" Firmware way. Some properties are variables stored in the descriptor.
 * 
