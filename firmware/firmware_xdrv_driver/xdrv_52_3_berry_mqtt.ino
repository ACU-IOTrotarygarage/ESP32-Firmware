...
// Berry: `Firmware.publish(topic, payload [, retain:bool, start:int, len:int]) -> nil``
// is_method is true if called from Firmware class, false if called from mqtt module
extern "C" {
