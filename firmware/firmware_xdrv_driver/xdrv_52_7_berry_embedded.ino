...
const char berry_prog[] =
  ...
  "Firmware = Firmware() "
  "def log(m,l) Firmware.log(m,l) end "
  "def load(f) return Firmware.load(f) end "

  // try to resize FS to max at first boot
  // "Firmware.log('>>> bootcount=' + str(Firmware.settings.bootcount), 2) "
  "if Firmware.settings.bootcount == 0 "
...
#ifdef USE_I2C
  "Firmware.wire1 = Wire(1) "
  "Firmware.wire2 = Wire(2) "
  "wire1 = Firmware.wire1 "
  "wire2 = Firmware.wire2 "
#endif // USE_I2C
