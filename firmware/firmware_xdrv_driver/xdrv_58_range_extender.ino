/*
  xdrv_58_range_extender.ino - WiFi Range Extender for Firmware

  Copyright (C) 2021  sillyfrog and Theo Arends and Mahmoud Shams El-Din
...
For example, in your platfromio_Firmware_cenv.ini, you will need an entry such as:
[env:Firmware-rangeextender]
...
bool Xdrv58(uint32_t function)
{
  ...
  else if (Settings->sbflag1.range_extender && !FirmwareGlobal.restart_flag)
  {
    switch (function)
    {
    case FUNC_PRE_INIT:
