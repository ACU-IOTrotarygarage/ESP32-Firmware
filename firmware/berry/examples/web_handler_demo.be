...
- and displays a Firmware styled web page
-
- Copy the following in `autoexec.be` in Firmware file system
-----------------------------------------------------------------------#
...
class Web_page_demo : Driver
  ...
  def page_say_hello()
    ...
    webserver.content_send("Firmware says hello!")   #- send any html -#
...
Firmware.add_driver(web_page_demo_instance)
