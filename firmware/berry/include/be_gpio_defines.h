...
const be_const_member_t lv_gpio_constants[] = {
    ...
    { "FirmwareCLIENT_RST", (int32_t) GPIO_FirmwareCLIENT_RST },
    { "FirmwareCLIENT_RST_INV", (int32_t) GPIO_FirmwareCLIENT_RST_INV },
    { "FirmwareCLIENT_RXD", (int32_t) GPIO_FirmwareCLIENT_RXD },
    { "FirmwareCLIENT_TXD", (int32_t) GPIO_FirmwareCLIENT_TXD },
