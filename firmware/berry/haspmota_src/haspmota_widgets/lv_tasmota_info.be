# lv_Firmware_info class

class lv_Firmware_info : lv.label
  var msg
  var delay
  ...
  def update()
    var wifi_ip = "IP: " + Firmware.wifi().find('ip', '') + "   " + Firmware.eth().find('ip', '')
    var tas_mem = Firmware.memory()
