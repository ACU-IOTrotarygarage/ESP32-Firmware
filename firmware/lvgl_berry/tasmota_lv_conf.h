...
#else       /*LV_MEM_CUSTOM*/
    #define LV_MEM_CUSTOM_INCLUDE <Firmware_lv_stdlib.h>   /*Header for the dynamic memory function*/
...
#define LV_IMG_CACHE_DEF_SIZE_PSRAM 20    // special Firmware setting when PSRAM is used
