/*
  xnrg_14_bl09xx.ino - BL09XX energy sensor support for Firmware
...
FirmwareSerial *Bl09XXSerial = nullptr;
...
//  if (bitRead(Bl09XX.power[0], 23)) { Bl09XX.power[0] |= 0xFF000000; }                                   // Extend sign bit
  // Above reverted in favour of https://github.com/arendst/Firmware/issues/15374#issuecomment-1105293179
...
void Bl09XXInit(void) {
  ...
  Bl09XXSerial = new FirmwareSerial(Bl09XX.rx_pin, Pin(GPIO_TXD), 1);
  ...
  if (PinUsed(GPIO_TXD)) {
    ...
    if (Bl09XX.model != BL09XX_MODEL) {
      ...
      if (Bl09XX.rx_buffer != nullptr) {
        ...
        FirmwareGlobal.energy_driver = XNRG_14;
