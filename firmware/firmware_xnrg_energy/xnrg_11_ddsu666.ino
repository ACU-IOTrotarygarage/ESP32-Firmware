/*
  xnrg_11_ddsu666.ino - Chint DDSU666-Modbus energy meter support for Firmware

  Copyright (C) 2021  Pablo Zerón and Theo Arends and Mahmoud Shams El-Din
...
{
  Ddsu666Modbus = new FirmwareModbus(Pin(GPIO_DDSU666_RX), Pin(GPIO_DDSU666_TX), Pin(GPIO_NRG_MBS_TX_ENA));
...
void Ddsu666DrvInit(void)
{
  if (PinUsed(GPIO_DDSU666_RX) && PinUsed(GPIO_DDSU666_TX)) {
    FirmwareGlobal.energy_driver = XNRG_11;
  }
}
