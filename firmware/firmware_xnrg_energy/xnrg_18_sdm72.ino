/*
  xnrg_18_sdm72.ino - Eastron SDM72D-M Modbus energy meter support for Firmware

  Copyright (C) 2021  Gennaro Tortone, Theo Arends and Mahmoud Shams El-Din and Norbert Richter
...
{
  Sdm72Modbus = new FirmwareModbus(Pin(GPIO_SDM72_RX), Pin(GPIO_SDM72_TX), Pin(GPIO_NRG_MBS_TX_ENA));
...
void Sdm72DrvInit(void)
{
  if (PinUsed(GPIO_SDM72_RX) && PinUsed(GPIO_SDM72_TX)) {
    ...
    FirmwareGlobal.energy_driver = XNRG_18;
  }
}
