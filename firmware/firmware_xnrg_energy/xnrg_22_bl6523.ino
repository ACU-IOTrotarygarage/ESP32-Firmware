/*
  xnrg_22_bl6523.ino - BL6523 based Watt hour meter support for Firmware
 ...
 * To use Firmware the user needs to add an ESP8266 or ESP32
...
FirmwareSerial *Bl6523RxSerial;
FirmwareSerial *Bl6523TxSerial;
...
void Bl6523Init(void)
{
    ...
    Bl6523.type = 0;
    Bl6523RxSerial = new FirmwareSerial(Pin(GPIO_BL6523_RX), -1, 1);
    Bl6523TxSerial = new FirmwareSerial(Pin(GPIO_BL6523_TX), -1, 1);
...
void Bl6523DrvInit(void)
{
  if (PinUsed(GPIO_BL6523_RX) && PinUsed(GPIO_BL6523_TX)) {
    ...
    FirmwareGlobal.energy_driver = XNRG_22;
