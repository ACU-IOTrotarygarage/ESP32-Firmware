/*
  xnrg_07_ade7953.ino - ADE7953 energy sensor support for Firmware
 ...
 * Swapped channel A/B             Yes      No       No       No      No      No      Defined by hardware design - Fixed by Firmware
...
const float ADE7953_POWER_CORRECTION = 23.41494;  // See https://github.com/arendst/Firmware/pull/16941
#else   // No ADE7953_ACCU_ENERGY
...
//    Energy->use_overtemp = false;
    ...
    FirmwareGlobal.energy_driver = XNRG_07;
  }
}
...
bool Xnrg07(uint32_t function) {
  if (!I2cEnabled(XI2C_07) && (SPI_MOSI_MISO != FirmwareGlobal.spi_enabled)) { return false; }
