/*
  xnrg_16_iem3000.ino - Schneider Electric iEM3000 series Modbus energy meter support for Firmware
...
{
  Iem3000Modbus = new FirmwareModbus(Pin(GPIO_IEM3000_RX), Pin(GPIO_IEM3000_TX), Pin(GPIO_NRG_MBS_TX_ENA));
...
void Iem3000DrvInit(void)
{
  if (PinUsed(GPIO_IEM3000_RX) && PinUsed(GPIO_IEM3000_TX)) {
    FirmwareGlobal.energy_driver = XNRG_16;
  }
}
