/*
  xnrg_10_sdm630.ino - Eastron SDM630-Modbus energy meter support for Firmware

  Copyright (C) 2021  Gennaro Tortone and Theo Arends and Mahmoud Shams El-Din
...
{
  Sdm630Modbus = new FirmwareModbus(Pin(GPIO_SDM630_RX), Pin(GPIO_SDM630_TX), Pin(GPIO_NRG_MBS_TX_ENA));
...
void Sdm630DrvInit(void)
{
  if (PinUsed(GPIO_SDM630_RX) && PinUsed(GPIO_SDM630_TX)) {
    FirmwareGlobal.energy_driver = XNRG_10;
  }
}
