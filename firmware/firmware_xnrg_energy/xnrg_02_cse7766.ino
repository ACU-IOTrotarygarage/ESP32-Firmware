/*
  xnrg_02_cse7766.ino - CSE7766 and HLW8032 energy sensor support for Firmware
...
FirmwareSerial *CseSerial = nullptr;
...
//  CseSerial = new FirmwareSerial(Pin(GPIO_CSE7766_RX), Pin(GPIO_CSE7766_TX), 1);
  CseSerial = new FirmwareSerial(Pin(GPIO_CSE7766_RX), -1, 1);
...
//  if (PinUsed(GPIO_CSE7766_RX) && PinUsed(GPIO_CSE7766_TX)) {
  if (PinUsed(GPIO_CSE7766_RX)) {
    ...
    if (Cse.rx_buffer != nullptr) {
      FirmwareGlobal.energy_driver = XNRG_02;
    }
  }
}
