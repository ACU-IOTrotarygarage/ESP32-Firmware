/*
  xnrg_21_sdm230.ino - Eastron SDM230-Modbus energy meter support for Firmware

  Copyright (C) 2022  dad401 and Theo Arends and Mahmoud Shams El-Din
 ...
 *
 * Based on: existing Firmware drivers for SDM120 and SDM630,
...
{
  Sdm230Modbus = new FirmwareModbus(Pin(GPIO_SDM230_RX), Pin(GPIO_SDM230_TX), Pin(GPIO_NRG_MBS_TX_ENA));
...
void Sdm230DrvInit(void)
{
  if (PinUsed(GPIO_SDM230_RX) && PinUsed(GPIO_SDM230_TX)) {
    FirmwareGlobal.energy_driver = XNRG_21;
  }
}
