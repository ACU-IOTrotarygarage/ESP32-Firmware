/*
  xnrg_23_ade7880.ino - ADE7880 energy sensor support for Firmware

  SPDX-FileCopyrightText: 2022 Theo Arends and Mahmoud Shams El-Din and AndreKR
 ...
 * I2C Address: 0x38
 *********************************************************************************************
 * - ATTENTION Before installing Firmware retrieve the calibration data from the Shelly 3EM:
 ...
 * - Install Firmware and use the above template.
 ...
 * - Restart Firmware and obeserve that the results seem calibrated as Firmware now uses the information from calib.dat
\*********************************************************************************************/
...
//    Energy->kWhtoday_delta[phase] += Energy->active_power[phase] * 1000 / 36;
    ...
    // 273 * 402653184 / 16384000 = 6709 = 67,09W * 1000 / 36 = 1863 deca micro Wh (Firmware needs deca micro Wh)
...
//        Energy->use_overtemp = true;                                        // Use global temperature for overtemp detection
        ...
        FirmwareGlobal.energy_driver = XNRG_23;
      }
    }
  }
}
