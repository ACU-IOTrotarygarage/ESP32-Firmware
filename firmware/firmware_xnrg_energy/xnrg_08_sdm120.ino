/*
  xnrg_08_sdm120.ino - Eastron SDM120-Modbus energy meter support for Firmware
...
{
  Sdm120Modbus = new FirmwareModbus(Pin(GPIO_SDM120_RX), Pin(GPIO_SDM120_TX), Pin(GPIO_NRG_MBS_TX_ENA));
...
void Sdm120DrvInit(void)
{
  if (PinUsed(GPIO_SDM120_RX) && PinUsed(GPIO_SDM120_TX)) {
    FirmwareGlobal.energy_driver = XNRG_08;
  }
}
